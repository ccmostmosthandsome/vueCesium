...
GlobePointDrawer.prototype = {
    ...
    drawHandler: null,
    modifyHandler: null,
    okHandler: null,//点击ok按钮的回调函数
    cancelHandler: null,//点击cancel按钮的回调函数
    ...
    _showToolBar: function () {
        var _this = this;
        _this._createToolBar();//创建确定取消工具栏
    ...
    _createToolBar: function () {
        ...
        btnOK.unbind("click").bind("click", function () {//点击ok按钮
            _this.clear();
            layer.close(_this.toolBarIndex);
            if (_this.okHandler) {
            ...
            var objs = $("#shapeEditContainer");//移除编辑按钮
            objs.remove();
        });
        btnCancel.unbind("click").bind("click", function () {//点击取消按钮
            _this.clear();
            layer.close(_this.toolBarIndex);
